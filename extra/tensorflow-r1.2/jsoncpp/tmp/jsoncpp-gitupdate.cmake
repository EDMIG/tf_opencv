...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" show-ref 4356d9b
  WORKING_DIRECTORY "F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/jsoncpp/src/jsoncpp"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" rev-list --max-count=1 4356d9b
  WORKING_DIRECTORY "F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/jsoncpp/src/jsoncpp"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/jsoncpp/src/jsoncpp/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/jsoncpp/src/jsoncpp/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" checkout 4356d9b
      WORKING_DIRECTORY "F:/tensorflow-r1.2/tensorflow-r1.2/tensorflow/contrib/cmake/build/jsoncpp/src/jsoncpp"
      RESULT_VARIABLE error_code
      )
    if(error_code)
